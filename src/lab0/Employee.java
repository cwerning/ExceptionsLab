...
public class Employee {
    private int minVactionDays=0;
    private int maxVactionDays=28;
    ...
    public final void setDaysVacation(int daysVacation) {
        if(daysVacation < minVactionDays || daysVacation > maxVactionDays)
        {
            throw new IllegalArgumentException("Bad Value for days vacation");
        }
